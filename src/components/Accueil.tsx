        ...
        <div className="grid grid-cols-1 text-center sm:text-start lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="flex items-center cursor-pointer space-x-3 bg-gray-900/80 hover:bg-gray-800/80 border border-gray-700 hover:border-yellow-400 px-6 py-3 rounded-lg transition-all duration-300 group">
